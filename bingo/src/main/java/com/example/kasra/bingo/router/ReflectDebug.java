...
public class ReflectDebug extends BaseRouter
{
	...
	{
		{
			Map<String, List<String>> decodedQueryParameters = BingoServer.decodeQueryParams(session.getQueryParameterString());
