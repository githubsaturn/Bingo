package com.example.kasra.bingo.Utils.common.constant;
...
public class DbConstants
{
	...
	static
	{
		...
		CREATE_IMAGE_SDCARD_CACHE_TABLE_INDEX_SQL.append("CREATE INDEX ").append(IMAGE_SDCARD_CACHE_TABLE_INDEX_TAG).append(" ON ").append(
				IMAGE_SDCARD_CACHE_TABLE_TABLE_NAME).append("(").append(IMAGE_SDCARD_CACHE_TABLE_TAG).append(")").append(TERMINATOR).append("CREATE INDEX ")
				.append(IMAGE_SDCARD_CACHE_TABLE_INDEX_URL).append(" ON ").append(IMAGE_SDCARD_CACHE_TABLE_TABLE_NAME).append("(").append(
				IMAGE_SDCARD_CACHE_TABLE_URL).append(")").append(TERMINATOR);
		...
		CREATE_HTTP_CACHE_TABLE_UNIQUE_INDEX.append("CREATE UNIQUE INDEX ").append(HTTP_CACHE_TABLE_UNIQUE_INDEX_URL).append(" ON ").append(
				HTTP_CACHE_TABLE_TABLE_NAME).append("(").append(HTTP_CACHE_TABLE_URL).append(")").append(TERMINATOR);
		CREATE_HTTP_CACHE_TABLE_INDEX_SQL.append("CREATE INDEX ").append(HTTP_CACHE_TABLE_INDEX_TYPE).append(" ON ").append(HTTP_CACHE_TABLE_TABLE_NAME).append(
